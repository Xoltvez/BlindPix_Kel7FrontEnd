...
const App = ({ navigation }) => {
  ...
  useEffect(() => {
    axios
      .get('https://db83-2001-448a-40a3-15fc-1d4f-64b4-f0ea-7b0f.ngrok-free.app/api/quizzes/level/12', {
  ...
  if (quizEnded) {
    const totalScore = correctCount * 25;
    return (
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={[styles.countText2, { paddingHorizontal: 36, paddingVertical: 12,backgroundColor: '#4E3BC9', borderRadius: 24, }]}>
        Pertanyaan {currentQuestion + 1} dari 8 Soal
      </Text>
      </View>
