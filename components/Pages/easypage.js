        ...
        <View style={{ backgroundColor: '#ffffff', flex: 1, marginTop: 180, borderRadius: 24 }}>
          ...
          <View style={{ marginHorizontal: 32, marginVertical: 32 }}>
            ...
            <View style={{ marginBottom: 48 }}>
              <Text style={Styles.textp}>A color blindness test at an easy level is designed to assess someone's ability to differentiate colors in a simple manner. Participants are tasked with identifying and distinguishing colors displayed in each pattern or image. This test helps identify whether someone has the basic ability to differentiate colors clearly</Text>
            </View>
